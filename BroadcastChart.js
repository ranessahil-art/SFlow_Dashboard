...
function BroadcastChart({selectedDate, selectedDevice, darkMode, selectedRange}) {
    ...
    useEffect(() => {
        ...
        const fetchTraffic = () => {
            ...
            axios.get(
                `http://10.21.1.38:8000/broadcast?date=${selectedDate}&range=${selectedRange}`
            )
                .then(response => {
          ...
          >
            ...
            >
                ...
                <YAxis
                    ...
                    width={80}
                    label={{
                        value: "Difference in Broadcast Packets",
                        angle: -90,
                        position: "insideLeft",
                        fill: darkMode ? "white" : "#374151",
                        fontSize: 20,
